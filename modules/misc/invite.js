...
module.exports.config = {
  ...
  expandedHelp: 'Use `bulba invite` to invite the bot, `bulba invite server` for an invite to the help server (DMed to you) so you can yell at me.'
}
...
module.exports.events.message = (bot, message) => {
  ...
  bot.generateInvite(['EMBED_LINKS'])
    .then(link => {
      message.channel.send(`Invite me! ${link}\nUse \`bulba invite server\` for the help server!`);
    })
}
